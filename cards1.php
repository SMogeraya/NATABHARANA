...
<h2 style="text-align:center;color:white;" data-aos="zoom-in"  data-aos-duration="1300">Musical Instruments♫</h2>
    <div class="cardalign"  >
...
<div class="cardalign  px-10" style="margin:auto;"  >
    ...
    <div class="card" data-aos="flip-left"  data-aos-duration="1700">
        <img src="https://i.pinimg.com/originals/78/d1/b3/78d1b3f7fcaa61e65f91019ff5359c82.jpg" >
        <div class="cardcon">
            <h2>Veena</h2>
            <p>Veena is a stringed musical instrument that originated in India. It is used in Hindustani classical music and Carnatic classical music, from North and South India respectively. 
. </p>
            <div class="btnn btn btn-light">
            <a href="final.php#Veena" style="color:black;">Learn How </a>
    ...
    <div class="card" data-aos="flip-left"  data-aos-duration="1700">
        <img src="https://www.seawindmusic.com/wp-content/uploads/2015/03/9-11.jpg">
        <div class="cardcon">
            <h2>Saxophone</h2>
            <p>Saxophone always refreshes our minds and souls, it is one of the wonderful instruments that produce the good melody. </p>
            <div class="btnn btn btn-dark">
            <a href="final.php#Saxophone" style="color:white;">Learn How </a>
    ...
    <div class="card" data-aos="flip-left"  data-aos-duration="2100">
        <img src="https://natyamcostumes.com/wp-content/uploads/2019/08/Bharatnatyam-costume-38.jpg">
        <div class="cardcon">
            <h2>Costume</h2>
            <p>The foremost aharya that makes the difference!</p>
            <div class="btnn btn btn-light">
            <a href="final.php#Guitar">Learn How </a>
    ...
    <div class="card" data-aos="flip-left"  data-aos-duration="2100">
        <img src="https://m.media-amazon.com/images/I/81Np8jZXL5L._SY695_.jpg">
        <div class="cardcon">
            <h2>Temple Jewellery</h2>
            <p>These are a set of imitation temple jewellery that enhances the aharya!</p>
            <div class="btnn btn btn-light">
            <a href="final.php#Guitar">Learn How </a>
    ...
    <div class="card" data-aos="flip-left"  data-aos-duration="2100">
        <img src="https://i.pinimg.com/736x/1a/e7/11/1ae7116d03d2536bfd4afc9b000a38eb.jpg">
        <div class="cardcon">
            <h2>Hairstyle</h2>
            <p>Whether it is a braid or a bun, the right hairstyle portrays the character.</p>
            <div class="btnn btn btn-light">
            <a href="final.php#Guitar">Learn How </a>
    ...
    <div class="card" data-aos="flip-left"  data-aos-duration="2100">
        <img src="http://www.adarshadresspalace.com/make_%20up_%20material/make-up-kit-b.jpg">
        <div class="cardcon">
            <h2>Make-up items</h2>
            <p>Make-up goes a long way in turning even a normal person into a demon!</p>
            <div class="btnn btn btn-light">
            <a href="final.php#Guitar">Learn How </a>
    ...
    <div class="card" data-aos="flip-left"  data-aos-duration="2100">
        <img src="https://m.media-amazon.com/images/I/61gf9j+1tvL._SX679_.jpg">
        <div class="cardcon">
            <h2>Gejje</h2>
            <p>The most important jewel that adds rhythm to your moves.</p>
            <div class="btnn btn btn-light">
            <a href="final.php#Guitar">Learn How </a>
