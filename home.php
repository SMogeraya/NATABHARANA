...
#passerror,#moberror,#usnameerror{
    display:none;
}
...
<script>
    function validate()
    {
        pwd=document.getElementById('passerror');
        pwd.style.display="none";
        ph=document.getElementById('moberror');
        ph.style.display="none";
        uname=document.getElementById('usnameerror');
        ...
        if(pass.value.length<8)
        {
            ...
            pwd.textContent="*Password should contain 8 characters";
            return false;
        }
        mob=document.getElementById('mob');
         if(mob.value.length!=10) //|| !Number.isInteger(mob.value))
        {
           ph=document.getElementById('moberror');
           ph.style.display="block";
            ph.textContent="*Mobile Number should contain 10 Numbers";
            return false;
        }
        mob1=document.getElementById('mob').value;
        if((!IsInteger(ParseInt(mob1) ))){
            ph.style.display="block";
            ph.textContent=typeof mob1;
            return false;
        }

        user=document.getElementById('usname');
        if(user.value.length!=3)
        {
            uname.style.display="block";
            uname.textContent="*Name Should have minimum of 3 characters*";
            return false;
        }
        return true;
    }
...
<body>
  <div class="topbar">
    ...
    <div class="container" data-aos="zoom-in"  data-aos-duration="1000">
       <ul>
        <a href="#" onclick="signup()"><li class="signup">SIGN UP</li></a>
            <a href="loginact.php" onclick="login()"><li class="login">LOGIN</li></a>
            

        </ul>
<form  onsubmit="return validate();" action="saukya.php" method="post" id="fsignup">
    
    
<h1 style="font-family:DM Serif Display;font-size:34px;    margin-bottom: 0px;"> Registration form</h1>

<label for="mail">Enter Your Mail ID</label>
<!--<div class="ip"><img style="height:35px;width:35px"src="https://icon-library.com/images/email-icon-white-png/email-icon-white-png-25.jpg">--><input type="email" name="mail" size="20" id="mail" maxlength="20" required>


<label for="pass">Enter Password</label>
<input type="password" name="pass" size="10" id="pass" maxlength="20" required>
<span style=color:white><p id="passerror"></p></span>

<label for="usname">Enter Full Name</label>
<input type="text" name="usname" id="usname" minlength="3" maxlength="20"required >
<p id="usnameerror"></p>

<label for="mob">Enter Mobile Number</label>
<input type="tel" name="mob" id="mob" size="10" maxlength="10" required>
<p id="moberror"></p>
...
<footer class="foot" id="foot" data-aos="zoom-in"  data-aos-duration="1000">
...
<div class="botn"> <ul class="botnav">
            <li class="botli"><a class="bota"href="index.php"><div style="display:flex;flex-direction:row;"><i class="fa fa-home" style="color: white;font-size:20px;" ></i>HOME</a><div></li>
            <li class="botli"><a class="bota" href="index.php#foot"><i class="fa fa-quote-left" style="color: white;font-size:20px;" ></i>INFO</a></li>
            <li class="botli"><a class="bota" href="index.php#info"><i class="fa fa-briefcase" style="color: white;font-size:20px;" ></i>About Us</a></li>
            <li class="botli"><a class="bota" href="index.php#foot"><i class="fa fa-address-book" ></i>Contact</a></li>
