...
<style>
    .login,.login:hover{
        background-color: rgb(119, 29, 29) !important;
    padding: 20px;
...
.signup{
    background-color: rgb(213, 62, 62) !important;
    border-bottom: solid rgb(252, 243, 243) 2px;
   
}
.signup:hover{
    background-color: rgb(178, 35, 35) !important;
}
.topbar{
    width:100%;
    height: 60px;
...
<form  onsubmit=" return validate();" action="logindb.php" id="flogin" method ="post">
    <h1 style="font-size:35px;font-family:DM Serif Display;font-size:34px; "><u> LOG IN</u></h1>

    <label for="mail">Enter your mail id </label>
<input type="text" name="mail" size="20" id="mail" maxlength="20" required>
<br>
