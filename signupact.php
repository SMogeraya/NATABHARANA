...
<form  style="font-family:DM Serif Display;font-size:35px;" onsubmit=" return validate();" action="saukya.php" method="post" id="fsignup">
    
    
<h1 style="font-family:DM Serif Display;font-size:35px;">Registration Form</h1>

<label for="mail">Enter your mail id </label>
<input type="email" name="mail" size="20" id="mail" maxlength="20" required>
...
<footer class="foot" id="foot" data-aos="zoom-in"  data-aos-duration="2000">
