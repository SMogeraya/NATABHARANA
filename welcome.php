...
#latedisplay{
  scale:0;
    ...
    <script>
      var latedisplay=setTimeout(late,1000);
      function late(){
        document.getElementById("latedisplay").style.scale="1";
      }
      </script>
</head>
<body>
...
<div class="topbar">
    ...
    <h1 data-aos="zoom-in"  data-aos-duration="1300" style="margin-top:40px;">NATABHARANA</h1>
   ...
   <div id="latedisplay" class="conatiner" data-aos="zoom-in"  data-aos-duration="3000">
    <div class="con1" data-aos="flip-left"  data-aos-duration="3000">
        <div class="cimg1 "></div>
        <div class="a a1" ><div class="cpara " data-aos="flip-left"  data-aos-duration="1000"><h3 style="margin-top:40px;">Music & Instruments</h3>
        <h4>Music a divine form of art from the vedas.A Wise man once said Music can name the unnameable and communicate the unknowable.It's the universal language.To Learn More about the divinity of music click the button below.</h4></div>
        <br><button type="button" class="btn btn-light bton"><a href="cards1.php">Try For Details</a></button></div>

    </div>
        
   
   <div class="con1" data-aos="flip-left"  data-aos-duration="2500">
   <br>
       <div class="cimg2" ></div>
      
       <div class="a a1"><div class="cpara" ><h3 display-1 style="margin-top:60px;">Dance & Aabharans</h3>
       <h4>Dance is a powerful impulse. The art of dance is that impulse channeled by skillful performers into something that becomes intensely expressive and that may delight spectators who feel no wish to dance themselves. To learn more about Dance and its instruments click the button below.</h4></div>
       <br><button type="button" class="btn btn-light bton"><a href="cards1.php">Try For Details</a></button></div>
    </div>
</div>
<footer class="foot" id="foot" data-aos="zoom-in"  data-aos-duration="2000" style="margin-top:10px;background-color: rgba(115, 21, 21,0.4);">
